...
public class GiveRespect extends RCONMessage<GiveRespect.JSONGiveRespect> {
    ...
    public void handle(Gson gson, JSONGiveRespect object) {
        ...
        if (habbo != null) {
            habbo.getHabboStats().increaseRespectPointsReceived(object.respect_received);
            habbo.getHabboStats().increaseRespectPointsGiven(object.respect_given);
            habbo.getHabboStats().increaseRespectPointsToGive(object.daily_respects);
